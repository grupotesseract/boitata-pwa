    ...
    <div className={styles.container}>
      ...
      <Row justify='center'>
        <Col lg={24} className={styles.containerInfos}>
          <p>
            Se preferir, fale direto conosco pelo whatsapp ou
            pelo chat ali no cantinho. É só falar um oi ;)
          </p>
        </Col>
      </Row>
      ...
      <Row className={styles.containerContato}>
        ...
        <Col xs={24} lg={8} className={`${styles.infosContainer} ${styles.teste}`}>
          <ul>
            ...
            <li className={styles.email}>
              <a href={'mailto:caroline@coletivoboitata.com.br'} target='_blank' rel='noopener noreferrer'>
                <Icone nome='email'/>
        ...
        <Col xs={24} lg={8} className={styles.infosContainer}>
          <ul>
            ...
            <li className={styles.email}>
              <a href={'mailto:thomas@coletivoboitata.com.br'} target='_blank' rel='noopener noreferrer'>
                <Icone nome='email'/>
